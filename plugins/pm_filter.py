...
async def next_page(bot, query):
    ...
    btn.insert(0, [
        InlineKeyboardButton(text="⚠️ 𝐉𝐨𝐢𝐧 𝐌𝐨𝐯𝐢𝐞𝐬 Group ⚠️", url="https://t.me/hub1234ggmovie")
    ])
    try:
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('💠 CHANNEL 💠', url='https://t.me/hub1234ggmovie'),
            InlineKeyboardButton('☎️ CONTACT ME', url='https://t.me/dark_webos'),
            InlineKeyboardButton('💠 UPDATES 💠', url='')
            ],[
            InlineKeyboardButton('♻️ Help ♻️', callback_data='help'),
            InlineKeyboardButton('🌷Join my group', url='https://t.me/hub1234ggmovie'),
            InlineKeyboardButton('♻️ About ♻️', callback_data='about')
            ],[
            InlineKeyboardButton('✅ Subscribe my YouTube channel ✅', url='')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('🌴 Bots Channel 🌴', url='https://t.me/hub1234ggmovie'),
